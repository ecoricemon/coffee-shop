...
export default class GUIHelper { 
   ...
   * @returns {GUIHelper} Instance for method chaining.
   */
  static addPointLightHelper(scene, light) {
   ...
   * @returns {GUIHelper} Instance for method chaining.
   */
  static addHemisphereLightHelper(scene, light, size = 5, color = 0xffffff) {
    scene.add(new THREE.HemisphereLightHelper(light, size, color));
    return GUIHelper.#getInstance();
  }
   ...
   * @returns {GUIHelper} Instance for method chaining.
   */
  static addRectAreaLightHelper(light) {
